...
void loadResources() {
    ...
    iLoadFramesFromFolder(frames_obstacle, "assets/images/sprites/Obstacle/Untitled-1.png");
    iChangeSpriteFrames(&sprite, frames, 6);
    iChangeSpriteFrames(&sprite_2, 1);
    
    iSetSpritePosition(&sprite, 350 , 200);
    iSetSpritePosition(&sprite_2, 100, 200);
    iScaleSprite(&sprite, 0.3);
    iScaleSprite(&sprite_2, 0.4);
...
void iKeyboard(unsigned char key)
{
    ...
    {
    case 32:
        iSetSpritePosition(&sprite, 350, 250);
        break;
