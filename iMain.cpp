...
void aboutUs()
{
    if (is_aboutus)
    {
        iShowLoadedImage(60, 120, &aboutuspage);
    }
}
...
void showBird()
{
    if (!is_leaderboard && game_status && !is_aboutus)
    {
        iShowSprite(&sprite);
    }
}
...
void loadPlayButton()
{
    if (!start_checker && !is_leaderboard && !is_name && is_home && !level_checker)
    {
        if (!is_aboutus)
        {
            ...
            iText(415, 25, "Press 'ESC' to exit.", GLUT_BITMAP_HELVETICA_18);
        }
        if (is_sound_on)
            iShowLoadedImage(-10, 0, &sound_on);
        else
            iShowLoadedImage(-10, 0, &sound_off);

        iShowLoadedImage(880, 0, &about_us);
    }
...
void loadResources()
{
    ...
    iLoadImage(&sound_on, "assets/images/sound-on.png");
    iLoadImage(&sound_off, "assets/images/sound-off.png");
    iLoadImage(&about_us, "assets/images/aboutus.png");
    iLoadImage(&aboutuspage, "assets/images/aboutustemplate.png");
    ...
    iResizeImage(&sound_on, 129, 78);
    iResizeImage(&sound_off, 129, 78);
    iResizeImage(&about_us, 129, 78);
    iResizeImage(&aboutuspage, 880, 630);
...
void iMouse(int button, int state, int mx, int my)
{
    if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
    {
        ...
        else if (!is_leaderboard && !is_name && !is_home && (mx > 377 && mx < 630 && my > 520 && my < 600) && level_checker)
        { // level 1
            iPlaySound("assets/sounds/click.wav", false, 100);
            is_home = 1;
            select_level(1);
        ...
        else if (!is_leaderboard && !is_name && !is_home && (mx > 377 && mx < 639 && my > 400 && my < 480) && level_checker)
        { // level 1SRR
            iPlaySound("assets/sounds/click.wav", false, 100);
            is_home = 1;
            select_level(2);
        ...
        else if (!is_leaderboard && !is_name && !is_home && (mx > 377 && mx < 630 && my > 270 && my < 350) && level_checker)
        { // level 1
            iPlaySound("assets/sounds/click.wav", false, 100);
            is_home = 1;
            select_level(3);
        ...
        else if (is_home == 1 && is_name == 0 && is_leaderboard == 0 && mx > -10 && mx < 100 && my > 0 && my < 80)
        {
            iPlaySound("assets/sounds/click.wav", false, 100);
            is_sound_on ^= 1;
            toggleSound();
        }
        else if (is_home == 1 && is_name == 0 && is_leaderboard == 0 && mx > 880 && mx < 1000 && my > 0 && my < 80)
        {
            iPlaySound("assets/sounds/click.wav", false, 100);
            is_aboutus ^= 1;
        }
